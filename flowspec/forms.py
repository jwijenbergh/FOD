...
class SetupForm(forms.Form):
    ...
    netconf_device = forms.CharField(label="Router host (NETCONF)", required=True,initial='1.0.0.0')
    netconf_port = forms.IntegerField(label="Router port (NETCONF)", min_value=0, max_value=65535, required=True,initial='65535')
    ...
    test_peer_addr = forms.CharField(label="Test peer IP subnet", required=True,initial='1.0.0.0/8')
